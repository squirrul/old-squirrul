...
// EXTERNAL MODULE: ../node_modules/gun/gun.js
var gun = __webpack_require__("R2pP");
...
var formatNotes = function formatNotes(notes) {
	return Object.keys(notes).map(function (key) {
		return { key: key, val: notes[key] };
	}).filter(function (t) {
		return Boolean(t.val) && t.key !== '_';
	});
};
...
var home_Home = function (_Component) {
	...
	function Home(props) {
		...
		_this.add = function (e) {
			e.preventDefault();
			_this.gun.get(gun_default.a.text.random()).put(_this.state.newNote);
			_this.setState({ newNote: '' });
		};

		_this.remove = function (key) {
			return function (e) {
				e.preventDefault();
				_this.gun.get(key).put(null);
			};
		};

		_this.handleChange = function (e) {
			return _this.setState({ newNote: e.target.value });
		};
	...
	Home.prototype.render = function render(_, _ref) {
		var _this3 = this;
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				'form',
				{ onSubmit: this.add },
				Object(preact_min["h"])('input', { value: newNote, onChange: this.handleChange }),
				Object(preact_min["h"])(
					'button',
					{ onClick: this.add },
					'Add'
			...
			Object(preact_min["h"])(
				...
				notes.map(function (note) {
					return Object(preact_min["h"])(
						'li',
						{ key: note.key, onClick: _this3.remove(note.key) },
						note.val
					);
				})
			)
	...
	App.prototype.render = function render() {
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(home_Home, { path: '/', gun: this.gun }),
				app__ref2,
				app__ref3
			)
		);
